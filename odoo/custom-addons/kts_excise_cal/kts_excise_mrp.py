...
class kts_product_template_excise(models.Model):
    ...
    mrp_price = fields.Float(string='Maximum Retail Price',digits_compute=dp.get_precision('Product Price'),default=0.0)
...
class kts_sale_order_line_excise(models.Model):
    ...
    mrp_price=fields.Float('MRP',digits_compute=dp.get_precision('Product Price'),store=True,default=0.0)
...
class kts_invoice_line_excise(models.Model):
    ...
    mrp_price=fields.Float('MRP',digits_compute=dp.get_precision('Product Price'))
