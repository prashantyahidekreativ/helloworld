...
class pos_order(osv.osv):
    ...
    def _amount_line_tax(self, cr, uid, line, fiscal_position_id, context=None):
        ...
        context.update({'pos_tax':True})   
        taxes = taxes.with_context(context).compute_all(price, cur, line.qty, product=line.product_id, partner=line.order_id.partner_id or False)['taxes']
        val = 0.0
        for c in taxes:
    ...
    def action_invoice(self, cr, uid, ids, context=None):
        ...
        for order in self.pool.get('pos.order').browse(cr, uid, ids, context=context):
            ...
            inv = {
                ...
                'user_id': uid,
                'tax_type':order.fiscal_position_id.tax_type
            }
            ...
            inv_ref.write(cr, uid, [inv_id],{'fiscal_position_id':order.fiscal_position_id.id},context=local_context)
