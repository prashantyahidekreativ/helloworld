...
class website_sale(http.Controller):
    ...
    def shop(self, page=0, category=None, search='', ppg=False, **post):
        ...
        product_ids = product_obj.search(cr, uid, domain, limit=ppg, offset=pager['offset'], order='website_published desc, website_sequence desc, list_price asc', context=context)
